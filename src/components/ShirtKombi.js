...
import shirtImage from '../images/kombi.jpg';

function ShirtKombi(props) {
    // actual Skus
    const smallSku = 'sku_FjiWheGizQLLLd';
    const mediumSku = 'sku_FjiYYNu3qbqfOc';
    const largeSku = 'sku_FjiYbXyfB71Ckk';
    ...
    if (purchaseClicked) {
        return (
            <div className="address-container">
                <Header />
                <AddressForm shirtName="Kombi" size={shirtSize} shirtSku={shirtSku} />
            </div>
        );
    }
