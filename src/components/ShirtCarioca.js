...
import shirtImage from '../images/carioca.jpg';

function ShirtCarioca(props) {
    // actual Skus
    const smallSku = 'sku_FhphJ9grbqCgHb';
    const mediumSku = 'sku_FhpjVYKKzr2rKi';
    const largeSku = 'sku_Fhpj28aZk8DWnG';
    ...
    if (purchaseClicked) {
        return (
            <div className="address-container">
                <Header />
                <AddressForm shirtName="Carioca" size={shirtSize} shirtSku={shirtSku} />
            </div>
        );
    }
