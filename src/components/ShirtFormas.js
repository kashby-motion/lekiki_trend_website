...
import shirtImage from '../images/formas.jpg';

function ShirtFormas(props) {
    // actual Skus
    const smallSku = 'sku_FjitstCDMh006x';
    const mediumSku = 'sku_FjitEoS57XIf1k';
    const largeSku = 'sku_FjiucLY5hInSMt';
    ...
    if (purchaseClicked) {
        return (
            <div className="address-container">
                <Header />
                <AddressForm shirtName="Formas" size={shirtSize} shirtSku={shirtSku} />
            </div>
        );
    }
